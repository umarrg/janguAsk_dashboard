                ...
                <v-list>
                  <v-list-item>
                    <v-list-item-icon class="pa-0">
                      <v-avatar color="#707070">
                        <v-icon color="white"> mdi-video-plus</v-icon>
                      </v-avatar>
                    </v-list-item-icon>
              ...
              <v-card>
                <v-list>
                  <v-list-item>
                    <v-list-item-icon>
                      <v-avatar color="#707070">
                       <v-file-input accept="image/*" label="" prepend-icon="mdi-image-multiple" color="white" hide-input></v-file-input>
